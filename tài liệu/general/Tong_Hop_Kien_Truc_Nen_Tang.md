...
- **Graceful Degradation**: Tự động "xuống cấp nhẹ nhàng". Ví dụ: Khi ClickHouse đang bảo trì, hệ thống tự động switch Dashboard sang dùng PostgreSQL với hiệu năng chậm hơn nhưng không bị "sập" hoàn toàn. (Fallback cho luồng failure)
